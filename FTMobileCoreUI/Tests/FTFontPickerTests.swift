...
final class FTFontPickerViewprotocolTest: FTFontPickerViewprotocol {
...
class FTFontPickerTests: XCTestCase {
    
    let model = FTFontPickerModel()
    lazy var pickerView = FTFontPickerView.fromNib() as? FTFontPickerView

    var testPickerModel: FTFontPickerModel {
        let localModel = FTFontPickerModel()
    ...
    func assertPickerView(pickerView: FTFontPickerView?) {
    ...
    func testFontPickerViewUpdateModel() {
        let localPickerView = FTFontPickerView.fromNib() as? FTFontPickerView
    ...
    func testFontPickerViewController() {
        let pickerVC = FTFontPickerViewController()
        XCTAssertNotNil(pickerVC.pickerView)
        XCTAssertNotNil(pickerVC.fontPickerModel)
        
        // Picker Delegate
        pickerVC.fontPickerViewDelegate = FTFontPickerViewprotocolTest()
        ...
        // loadView
        pickerVC.loadView()
        let subView: FTFontPickerView? = pickerVC.mainView?.findInSubView()
